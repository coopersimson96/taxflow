          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-6">
              ...
              <nav className="hidden md:flex space-x-4">
                <a href="/dashboard" className="text-gray-300 hover:text-accent-300 px-3 py-2 text-sm font-semibold transition-colors">
                  Dashboard
                </a>
                <a href="/settings" className="text-gray-300 hover:text-accent-300 px-3 py-2 text-sm font-semibold transition-colors">
                  Settings
                </a>
              </nav>
            </div>
