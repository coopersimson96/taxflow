      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="card">
          <div className="space-y-6">
            <div>
              <label htmlFor="shopDomain" className="block text-sm font-medium text-primary-900 mb-2">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                  <span className="text-muted text-sm">.myshopify.com</span>
                </div>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-secondary-500">
